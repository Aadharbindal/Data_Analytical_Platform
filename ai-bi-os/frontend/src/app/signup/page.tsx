...
import { Layers, Mail, Lock, Eye, EyeOff, Activity, ShieldCheck, Users, User } from "lucide-react";
      ...
      <div className="w-full max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-screen z-10">
        ...
        <div className="hidden lg:flex flex-col justify-center px-16 py-12 relative">
          ...
          <div className="max-w-lg mt-12">
            ...
            <h1 className="text-5xl font-bold tracking-tight mb-6 leading-[1.1]">
              Welcome <br /> to <span className="bg-gradient-to-r from-primary to-blue-400 text-transparent bg-clip-text">DataMind</span>
            </h1>
        ...
        <div className="flex items-center justify-center p-6 lg:p-12 relative">
          ...
          <div className="w-full max-w-[440px] p-10 rounded-[32px] bg-surface/60 backdrop-blur-2xl border border-border shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-10">
              <h2 className="text-[28px] font-bold text-foreground tracking-tight mb-2">Sign up</h2>
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-medium text-[15px] rounded-xl shadow-[0_4px_14px_rgba(0,112,243,0.3)] transition-all hover:shadow-[0_6px_20px_rgba(0,112,243,0.4)] mt-2" 
                disabled={isLoading}
              >
