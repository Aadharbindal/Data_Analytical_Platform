  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <Header />
        <main className={`flex-1 bg-background [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] ${isAnalytics ? "overflow-hidden" : "overflow-y-auto p-6 pb-12"}`}>
